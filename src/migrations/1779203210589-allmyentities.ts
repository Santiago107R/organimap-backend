...
export class Allmyentities1779203210589 implements MigrationInterface {
    name = 'Allmyentities1779203210589'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "password" text NOT NULL, "DNI" integer, "roles" text array NOT NULL DEFAULT '{docente}', "isActive" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_065d4d8f3b5adb4a08841eae3c8" UNIQUE ("name"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "docente_aula" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "dia" text NOT NULL, "horario" text NOT NULL, "docenteId" uuid NOT NULL, "aulaId" uuid NOT NULL, "cursoId" uuid NOT NULL, "materiaId" uuid NOT NULL, CONSTRAINT "PK_c09dea163a76045edcd6ae82cfc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "mapa" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "url" text NOT NULL, CONSTRAINT "UQ_4cee76ff3a50379aa3883add5e5" UNIQUE ("name"), CONSTRAINT "PK_a29030f21ea92b0c652646f6ef4" PRIMARY KEY ("id"))`);
